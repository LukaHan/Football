package com.football.football.rxjava;
...
public class RxjavaUtil {
     ...
     * @param uiTask
     */
    public static <T> void doInUIThread(com.football.football.rxjava.UITask<T> uiTask) {
     ...
     * @param <T>
     */
    public static <T> void doInUIThreadDelay(com.football.football.rxjava.UITask<T> uiTask, long time, TimeUnit timeUnit) {
        Observable.just(uiTask)
                .delay(time, timeUnit)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Action1<com.football.football.rxjava.UITask<T>>() {
                    @Override
                    public void call(com.football.football.rxjava.UITask<T> uitask) {
                        uitask.doInUIThread();
                    }
